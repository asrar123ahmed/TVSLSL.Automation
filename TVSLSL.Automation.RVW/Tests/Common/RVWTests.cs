namespace TVSLSL.Automation.RVW.Tests.Common
{
    ...
    public class RVWTests
    {
        ...
        public void SuiteSetup()
        {
            ...
            config.Load(@"D:\OneDrive - TVS Logistics Services Limited\Automation\TVSLSL\As_RVW_Transaction\TVSLSL.Automation.RVW\Tests\Data\Config\Test Run Config.xml");
